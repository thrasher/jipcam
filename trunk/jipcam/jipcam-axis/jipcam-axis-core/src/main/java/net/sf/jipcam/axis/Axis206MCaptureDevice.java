/*
 * Axis206MCaptureDevice.java (2007)
 *
...
/**
 * Describe an Axis206M CaptureDevice.
 * 
 * @author Nigel Simpson
 */
public class Axis206MCaptureDevice extends DataSource implements CaptureDevice {
	/**
	 * The full product name as returned from an API query for the Axis
	 * parameter: root.BRAND.PRODFULLNAME
	 */
	public static String PRODUCT_FULL_NAME = "AXIS 206M Network Camera";
	...
	public Axis206MCaptureDevice(MediaLocator locator)
			throws MalformedURLException {
		this(null, locator);
	}

	public Axis206MCaptureDevice(String deviceName, MediaLocator locator)
			throws MalformedURLException {
	 ...
	 * @param port
	 */
	public Axis206MCaptureDevice(String deviceName, String hostName, int port) {
		super(
	...
	public CaptureDeviceInfo getCaptureDeviceInfo() {
		...
		formats[1] = new JPEGFormat(new Dimension(640, 360),
				Format.NOT_SPECIFIED, Format.byteArray, (float) 10,
				Format.NOT_SPECIFIED, Format.NOT_SPECIFIED);
		formats[2] = new JPEGFormat(new Dimension(640, 480),
				Format.NOT_SPECIFIED, Format.byteArray, (float) 10,
				Format.NOT_SPECIFIED, Format.NOT_SPECIFIED);
		formats[3] = new JPEGFormat(new Dimension(1280, 720),
				Format.NOT_SPECIFIED, Format.byteArray, (float) 10,
				Format.NOT_SPECIFIED, Format.NOT_SPECIFIED);
		formats[4] = new JPEGFormat(new Dimension(1280, 960),
				Format.NOT_SPECIFIED, Format.byteArray, (float) 10,
				Format.NOT_SPECIFIED, Format.NOT_SPECIFIED);
		formats[5] = new JPEGFormat(new Dimension(1280, 1024),
				Format.NOT_SPECIFIED, Format.byteArray, (float) 10,
				Format.NOT_SPECIFIED, Format.NOT_SPECIFIED);
	...
	public static void main(String[] args) {
		try {
			if (args.length != 2) {
				System.out.println("Usage: Axis206MCaptureDevice HOST PORT");
				System.exit(1);
			}
			...
			Axis206MCaptureDevice cam = new Axis206MCaptureDevice(null, host,
					port);
